...
Maths = (function() {
  ...
  //#######################################################################
    class Vector3 {
        ...
        print()         {console.log([Util.fRound(this.x, 2), Util.fRound(this.y, 2), Util.fRound(this.z, 2)]);}
        ...
        scale(s) {this.x *= s; this.y *= s; this.z *= s; return this;}  // NEW

        
        dot(b)	 {return this.x*b.x + this.y*b.y + this.z*b.z;}		//DEPRECIATED
        cross(b) {                                                  //DEPRECIATED
      ...
      //....................................................................
        ...
        static createFromAxisAngle(axis,angle) {
            var w = Math.cos(Util.DEG2RAD * angle / 2),
                v = Vector3.scale(Math.sin(Util.DEG2RAD * angle / 2), axis);
